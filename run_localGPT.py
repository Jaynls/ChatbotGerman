...
def main(query, device_type="cuda" if torch.cuda.is_available() else "cpu",
    ...
    if docs_and_scores1[0][1] < 0.67:
        ...
        docs_and_scores2 = DB.similarity_search_with_relevance_scores(
            Temp_answer)
        print("\n> similarity score of Temp answer:")
        ...
        answer = answer
        docs_and_scores_ans = DB.similarity_search_with_relevance_scores(answer)
        print("\n> similarity score of answer orignal:")
        print(docs_and_scores_ans[0][1])
        # if docs_and_scores_ans[0][1] < 0.75:
        #     answer = "Ich weiß nicht"
